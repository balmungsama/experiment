...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Volumes/Pile Drive/OneDrive - University of Toronto/Labs/Inzlicht Lab/outside_project/experiment/test_experiment.psyexp',
...
instruct_p1 = visual.TextStim(win=win, name='instruct_p1',
    text=u'Hello. Thanks for coming in today.\r\n\n\rFor this task, you will be asked to observe a series of characters flash on the screen and try to identify any number(s) you see in the stream. The characters will appear quickly, so you will have to pay close attention.\r\n\n\rSometimes a stream of characters will contain two numbers, and other times it will only contain one. Each stream will contain 15 to 19 characters and last for about a second. \r\n\n\rWhen two numbers are presented, please enter the numbers via keyboard in the order they were presented. When only one number is presented, enter in the number you saw along with any random number.\r\n\n\rIf you at any point are not sure which number(s) were presented, you can just guess.\r\n\n\rYou will be presented two blocks of this task; each block lasting between 13 to 15 minutes.\n\n\n                                                        Press SPACE to continue.',
    font=u'Arial',
...
text = visual.TextStim(win=win, name='text',
    ...
    color=u'grey', colorSpace='rgb', opacity=0,
    depth=-1.0);
...
Probe_t1 = visual.TextStim(win=win, name='Probe_t1',
    text=u'What numbers did you see?',
    font=u'Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=0.0);
